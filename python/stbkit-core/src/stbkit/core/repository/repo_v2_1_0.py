...
from ._internal.ref_def_v2_1_0 import _key_field_names_v210, _ref_map_v210
from .repo_common import RepositoryBase, _DerefAccessor, _RefMap


class RepositoryV2_1_0(RepositoryBase):
    """ST-Bridge v2.1.0用のリポジトリ。

    インスタンスの生成はget_repositoryの利用を推奨します。
    """

    _key_field_names: ClassVar[dict[type[StBridgeElement], str]] = _key_field_names_v210
    _ref_map: ClassVar[_RefMap] = _ref_map_v210
