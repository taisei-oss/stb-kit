...
class StbExtElement(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        "object_name": _FI(
            py_type=str, data_type=_DT.STR, required=True, xml_name="objectName"
        ),
        "element_name": _FI(py_type=str, data_type=_DT.STR, xml_name="elementName"),
...
class StbSecBarParapetRcZigZag(StBridgeElement):
    """StbSecBarParapetRcZigZag：StbSecBarParapet_RC_ZigZag

    Attributes:
        pos (StbSecBarParapetRcZigZagPos): 属性
        strength (str): 属性
        d (str): 属性
        pitch (float): 属性
    """
...
class StbSecBarArrangementParapetRc(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_sec_bar_parapet_rc_zig_zag": _FI(
...
class StbSecOpenRc(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_sec_bar_arrangement_open_rc": _FI(
            ...
            max_occurs=1,
            min_occurs=1,
            py_type=StbSecBarArrangementOpenRc,
        ),
    }
...
class StbSecBarArrangement_PileRc(StBridgeElement):
    """StbSecBarArrangement_PileRc：StbSecBarArrangement_Pile_RC
    ...
    _xml_element_name: ClassVar[str] = "StbSecBarArrangement_Pile_RC"
...
class StbSecPileRc(StBridgeElement):
    ...
    Attributes:
        ...
        stb_sec_bar_arrangement_pile_rc (StbSecBarArrangement_PileRc): 子要素
    """
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_sec_bar_arrangement_pile_rc": _FI(
            kind=_FK.ELEMENT, max_occurs=1, py_type=StbSecBarArrangement_PileRc
        ),
    }
...
class StbSecFoundationRcOctagon(StBridgeElement):
    ...
    Attributes:
        width_x (float): 属性 X幅
        width_y (float): 属性 Y幅
        width_chanfer1_x (float): 属性
        width_chanfer1_y (float): 属性
        width_chanfer2_x (float): 属性
        width_chanfer2_y (float): 属性
        width_chanfer3_x (float): 属性
        width_chanfer3_y (float): 属性
        width_chanfer4_x (float): 属性
        width_chanfer4_y (float): 属性
        depth (float): 属性 厚さ
    """
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "width_chanfer1_x": _FI(
            py_type=float,
            data_type=_DT.NON_NEGATIVE_LENGTH,
            xml_type="nonNegativeLength",
            required=True,
            xml_name="width_chanfer1_X",
        ),
        "width_chanfer1_y": _FI(
            py_type=float,
            data_type=_DT.NON_NEGATIVE_LENGTH,
            xml_type="nonNegativeLength",
            required=True,
            xml_name="width_chanfer1_Y",
        ),
        "width_chanfer2_x": _FI(
            py_type=float,
            data_type=_DT.NON_NEGATIVE_LENGTH,
            xml_type="nonNegativeLength",
            required=True,
            xml_name="width_chanfer2_X",
        ),
        "width_chanfer2_y": _FI(
            py_type=float,
            data_type=_DT.NON_NEGATIVE_LENGTH,
            xml_type="nonNegativeLength",
            required=True,
            xml_name="width_chanfer2_Y",
        ),
        "width_chanfer3_x": _FI(
            py_type=float,
            data_type=_DT.NON_NEGATIVE_LENGTH,
            xml_type="nonNegativeLength",
            required=True,
            xml_name="width_chanfer3_X",
        ),
        "width_chanfer3_y": _FI(
            py_type=float,
            data_type=_DT.NON_NEGATIVE_LENGTH,
            xml_type="nonNegativeLength",
            required=True,
            xml_name="width_chanfer3_Y",
        ),
        "width_chanfer4_x": _FI(
            py_type=float,
            data_type=_DT.NON_NEGATIVE_LENGTH,
            xml_type="nonNegativeLength",
            required=True,
            xml_name="width_chanfer4_X",
        ),
        "width_chanfer4_y": _FI(
            py_type=float,
            data_type=_DT.NON_NEGATIVE_LENGTH,
            xml_type="nonNegativeLength",
            required=True,
            xml_name="width_chanfer4_Y",
        ),
        "depth": _FI(
            py_type=float, data_type=_DT.LENGTH, xml_type="length", required=True
        ),
...
class StbSecFoundationRcEqui_Triangle(StBridgeElement):
    """StbSecFoundationRcEqui_Triangle：StbSecFoundation_RC_Equi_Triangle

    Attributes:
        width_base (float): 属性
        width_chamfer (float): 属性
        depth (float): 属性
    """
    ...
    _xml_element_name: ClassVar[str] = "StbSecFoundation_RC_Equi_Triangle"
...
class StbSecFoundationRcTapered_Rect(StBridgeElement):
    """StbSecFoundationRcTapered_Rect：StbSecFoundation_RC_Tapered_Rect
    ...
    _xml_element_name: ClassVar[str] = "StbSecFoundation_RC_Tapered_Rect"
...
class StbSecFigureFoundationRc(StBridgeElement):
    ...
    Attributes:
        ...
        stb_sec_foundation_rc_tapered_rect (StbSecFoundationRcTapered_Rect): 子要素
        stb_sec_foundation_rc_triangle (StbSecFoundationRcTriangle): 子要素 StbSecFoundation_RC_Triangle(ＲＣ基礎断面形状・直角三角形)
        stb_sec_foundation_rc_equi_triangle (StbSecFoundationRcEqui_Triangle): 子要素
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_sec_foundation_rc_tapered_rect": _FI(
            kind=_FK.ELEMENT, max_occurs=1, py_type=StbSecFoundationRcTapered_Rect
        ),
        ...
        "stb_sec_foundation_rc_equi_triangle": _FI(
            kind=_FK.ELEMENT, max_occurs=1, py_type=StbSecFoundationRcEqui_Triangle
        ),
...
class StbSecBarSlabPrecast1Way(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "strength": _FI(py_type=str, data_type=_DT.STR),
        "d": _FI(py_type=str, data_type=_DT.STR, xml_name="D"),
        "pitch": _FI(py_type=float, data_type=_DT.LENGTH, xml_type="length"),
    }
...
class StbSecBarSlabRc1Way1(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        "pos": _FI(
            ...
            data_type=_DT.STR_ENUM,
            required=True,
            choices=("MAIN_TOP", "MAIN_BOTTOM", "TRANSVERS_TOP", "TRANSVERS_BOTTOM"),
        ),
        "strength": _FI(py_type=str, data_type=_DT.STR),
        "d": _FI(py_type=str, data_type=_DT.STR, required=True, xml_name="D"),
        "pitch": _FI(
...
class StbSecBeamSrc(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "is_foundation": _FI(py_type=bool, data_type=_DT.BOOL, xml_name="isFoundation"),
        "is_canti": _FI(py_type=bool, data_type=_DT.BOOL, xml_name="isCanti"),
        "is_out_in": _FI(py_type=bool, data_type=_DT.BOOL, xml_name="isOutIn"),
        "strength_concrete": _FI(py_type=str, data_type=_DT.STR),
...
class StbSecFigureBeamS(StBridgeElement):
    """StbSecFigureBeamS：StbSecFigureBeam_S
    ...
    _xml_element_name: ClassVar[str] = "StbSecFigureBeam_S"
...
class StbSecBeamS(StBridgeElement):
    ...
    Attributes:
        ...
        is_canti (bool): 属性 片持ち梁か否か
        is_out_in (bool): 属性
        stb_sec_figure_beam_s (StbSecFigureBeamS): 子要素
    """
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "is_canti": _FI(py_type=bool, data_type=_DT.BOOL, xml_name="isCanti"),
        "is_out_in": _FI(py_type=bool, data_type=_DT.BOOL, xml_name="isOutIn"),
        "stb_sec_figure_beam_s": _FI(
            kind=_FK.ELEMENT, max_occurs=1, min_occurs=1, py_type=StbSecFigureBeamS
        ),
    }
...
class StbSecBarArrangement_BeamRc(StBridgeElement):
    """StbSecBarArrangement_BeamRc：StbSecBarArrangement_Beam_RC
    ...
    _xml_element_name: ClassVar[str] = "StbSecBarArrangement_Beam_RC"
...
class StbSecBeamRc(StBridgeElement):
    ...
    Attributes:
        ...
        stb_sec_bar_arrangement_beam_rc (StbSecBarArrangement_BeamRc): 子要素
    """
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_sec_bar_arrangement_beam_rc": _FI(
            kind=_FK.ELEMENT, max_occurs=1, py_type=StbSecBarArrangement_BeamRc
        ),
    }
...
class StbSecBaseConventionalCftAnchorBolt(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "strength_bolt": _FI(py_type=str, data_type=_DT.STR, required=True),
        "arrangement_bolt": _FI(py_type=str, data_type=_DT.STR, required=True),
        "d1_x": _FI(
            py_type=float,
            data_type=_DT.LENGTH,
            xml_type="length",
...
class StbSecSteelColumnSrcThreeTypes(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_sec_column_src_three_types_shape_h": _FI(
            kind=_FK.ELEMENT,
            max_occurs=3,
            py_type=list[StbSecColumnSrcThreeTypesShapeH],
        ),
        "stb_sec_column_src_three_types_shape_box": _FI(
            kind=_FK.ELEMENT,
            max_occurs=3,
            py_type=list[StbSecColumnSrcThreeTypesShapeBox],
        ),
        "stb_sec_column_src_three_types_shape_pipe": _FI(
            kind=_FK.ELEMENT,
            max_occurs=3,
            py_type=list[StbSecColumnSrcThreeTypesShapePipe],
        ),
        "stb_sec_column_src_three_types_shape_cross": _FI(
            kind=_FK.ELEMENT,
            max_occurs=3,
            py_type=list[StbSecColumnSrcThreeTypesShapeCross],
        ),
        "stb_sec_column_src_three_types_shape_t": _FI(
            kind=_FK.ELEMENT,
            max_occurs=3,
            py_type=list[StbSecColumnSrcThreeTypesShapeT],
        ),
    }
...
class StbSecSteelColumnSrcNotSame(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_sec_column_src_not_same_shape_h": _FI(
            kind=_FK.ELEMENT, max_occurs=2, py_type=list[StbSecColumnSrcNotSameShapeH]
        ),
        "stb_sec_column_src_not_same_shape_box": _FI(
            kind=_FK.ELEMENT, max_occurs=2, py_type=list[StbSecColumnSrcNotSameShapeBox]
        ),
        "stb_sec_column_src_not_same_shape_pipe": _FI(
            kind=_FK.ELEMENT,
            max_occurs=2,
            py_type=list[StbSecColumnSrcNotSameShapePipe],
        ),
        "stb_sec_column_src_not_same_shape_cross": _FI(
            kind=_FK.ELEMENT,
            max_occurs=2,
            py_type=list[StbSecColumnSrcNotSameShapeCross],
        ),
        "stb_sec_column_src_not_same_shape_t": _FI(
            kind=_FK.ELEMENT, max_occurs=2, py_type=list[StbSecColumnSrcNotSameShapeT]
        ),
    }
...
class StbSlab(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "is_foundadtion": _FI(
            py_type=bool, data_type=_DT.BOOL, required=True, xml_name="isFoundadtion"
        ),
        "type_haunch": _FI(
...
class StbAxes(StBridgeElement):
    ...
    Attributes:
        ...
        stb_drawing_axis (StbDrawingAxis): 子要素
    """
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_drawing_axis": _FI(kind=_FK.ELEMENT, max_occurs=1, py_type=StbDrawingAxis),
    }
