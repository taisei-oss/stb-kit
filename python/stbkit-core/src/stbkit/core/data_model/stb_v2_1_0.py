...
class StbSecConnectionIsolatingDeviceSpShapePlateStart(StrEnum):
    """StbSecConnectionIsolatingDeviceSp.shape_plate_start で使用できる値。"""
...
class StbSecSteelFigureDampingDeviceHistoryKindSectionStiffner(StrEnum):
    """StbSecSteelFigureDampingDeviceHistory.kind_section_stiffner で使用できる値。"""
...
class StbWeldPartialPenetrationShapeBavel(StrEnum):
    """StbWeldPartialPenetration.shape_bavel で使用できる値。"""
...
class StbWeldPartialPenetrationSidBavel1(StrEnum):
    """StbWeldPartialPenetration.sid_bavel1 で使用できる値。"""
...
class StbWeldPartialPenetrationSidBavel2(StrEnum):
    """StbWeldPartialPenetration.sid_bavel2 で使用できる値。"""
...
class StbExportInformation(StBridgeElement):
    ...
    Attributes:
        ...
        stb_export_log (list[StbExportLog]): 子要素 StbExportLog(変換ログ)
    """

    _fields: ClassVar[dict[str, _FI]] = {
        "stb_export_policy": _FI(kind=_FK.ELEMENT, py_type=list[StbExportPolicy]),
        "stb_export_log": _FI(kind=_FK.ELEMENT, py_type=list[StbExportLog]),
    }
...
class StbWeldFillet(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "alfa1": _FI(py_type=float, data_type=_DT.LENGTH, xml_type="length"),
        "alfa2": _FI(py_type=float, data_type=_DT.LENGTH, xml_type="length"),
        "continuous": _FI(py_type=bool, data_type=_DT.BOOL),
        "location": _FI(
...
class StbWeldPartialPenetration(StBridgeElement):
    ...
    Attributes:
        ...
        shape_bavel (StbWeldPartialPenetrationShapeBavel): 属性
        sid_bavel1 (StbWeldPartialPenetrationSidBavel1): 属性
        sid_bavel2 (StbWeldPartialPenetrationSidBavel2): 属性
        min_t1 (float): 属性 板厚の下限
        max_t1 (float): 属性 板厚の上限
        r (float): 属性 ルート面
        alfa1 (int): 属性 開先角度1
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "shape_bavel": _FI(
            py_type=StbWeldPartialPenetrationShapeBavel,
            data_type=_DT.STR_ENUM,
            required=True,
            choices=("L", "V", "K"),
        ),
        "sid_bavel1": _FI(
            py_type=StbWeldPartialPenetrationSidBavel1,
            data_type=_DT.STR_ENUM,
            choices=("Front", "Reverse", "Both"),
        ),
        "sid_bavel2": _FI(
            py_type=StbWeldPartialPenetrationSidBavel2,
            data_type=_DT.STR_ENUM,
            choices=("Right", "Left"),
        ),
...
class StbWeldFullPenetration(StBridgeElement):
    ...
    Attributes:
        ...
        g (float): 属性 ルート間隔
        r (float): 属性 ルート面
        alfa1 (int): 属性 開先角度1（表面）
        alfa2 (int): 属性 開先角度2（裏面）
...
class StbStiffner(StBridgeElement):
    """スチフナープレート詳細：StbStiffner

    Attributes:
        id (int): 属性 ID
        guid (UUID): 属性 GUID
        name (str): 属性 符号
        strength_plate (str): 属性 スチフナーの材種
        thickness (float): 属性 スチフナーの厚さ
        b_x (float): 属性 スチフナーの寸法(Bx)
        b_y (float): 属性 スチフナーの寸法(By)
        id_weld (int): 属性 溶接ID
        cutback (int): 属性 溶接控え
    """
...
class StbStiffners(StBridgeElement):
    """スチフナープレート詳細（複数）：StbStiffners

    Attributes:
        stb_stiffner (list[StbStiffner]): 子要素 StbStiffner(スチフナープレート詳細)
    """

    _fields: ClassVar[dict[str, _FI]] = {
        "stb_stiffner": _FI(kind=_FK.ELEMENT, min_occurs=1, py_type=list[StbStiffner]),
    }
...
class StbConnections(StBridgeElement):
    ...
    Attributes:
        ...
        stb_stiffners (StbStiffners): 子要素 StbStiffners(スチフナープレート詳細（複数）)
    """
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_stiffners": _FI(kind=_FK.ELEMENT, max_occurs=1, py_type=StbStiffners),
    }
...
class StbJointShapeCross(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "strength_plate_web": _FI(py_type=str, data_type=_DT.STR, required=True),
        "strength_bolt": _FI(py_type=str, data_type=_DT.STR, required=True),
        "name_bolt": _FI(py_type=str, data_type=_DT.STR, required=True),
        "offset_h": _FI(
            py_type=float,
...
class StbSecBuildHAssymmetric(StBridgeElement):
    """組立H形鋼（上下異なる）：StbSecBuild-HAssymmetric

    Attributes:
        name (str): 属性 形状名
        a (float): 属性 成
        b_t (float): 属性 上部フランジ幅
        b_b (float): 属性 下部フランジ幅
        t1 (float): 属性 ウェブ厚
        t2_t (float): 属性 上部フランジ厚
        t2_b (float): 属性 下部フランジ厚
    """
    ...
    _xml_element_name: ClassVar[str] = "StbSecBuild-HAssymmetric"
...
class StbSecSteel(StBridgeElement):
    ...
    Attributes:
        ...
        stb_sec_build_h_assymmetric (list[StbSecBuildHAssymmetric]): 子要素 StbSecBuild-HAssymmetric(組立H形鋼（上下異なる）)
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_sec_build_h_assymmetric": _FI(
            kind=_FK.ELEMENT, py_type=list[StbSecBuildHAssymmetric]
        ),
...
class StbSecPanelZone(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "pitch_hoop": _FI(py_type=float, data_type=_DT.LENGTH, xml_type="length"),
...
class StbSecPenetrationSHiringExtension(StBridgeElement):
    ...
    Attributes:
        ...
        protruce_stick (float): 属性 スティックのウェブ面からの突出寸法
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "protruce_stick": _FI(py_type=float, data_type=_DT.LENGTH, xml_type="length"),
        "lh_stick": _FI(
...
class StbSecPileSConnection(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        "d_pile_band": _FI(py_type=str, data_type=_DT.STR, xml_name="D_pile_band"),
        "n_pile_band": _FI(
            py_type=int,
            data_type=_DT.POSITIVE_INTEGER,
            xml_type="positiveInteger",
            xml_name="N_pile_band",
        ),
        "strength_pile_head": _FI(py_type=str, data_type=_DT.STR),
        "d_inner": _FI(py_type=str, data_type=_DT.STR, xml_name="D_inner"),
        "n_inner": _FI(
...
class StbSecPileSProduct(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "product_code": _FI(py_type=str, data_type=_DT.STR, required=True),
        "release_time": _FI(py_type=str, data_type=_DT.STR, required=True),
        "length_pile": _FI(py_type=str, data_type=_DT.STR, required=True),
    }
...
class StbSecBarFoundationRcContinuous(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "main_type": _FI(
            ...
            data_type=_DT.STR_ENUM,
            choices=("SYMMETRICAL", "ASSYMMETRICAL"),
        ),
...
class StbSecConnectionDampingDeviceHorizontal(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        "method_start": _FI(
            ...
            data_type=_DT.STR_ENUM,
            required=True,
            choices=("BASEPLATE", "BOLT", "THROUGE_BOLT", "WELDING"),
        ),
        "t_plate_start": _FI(py_type=float, data_type=_DT.LENGTH, xml_type="length"),
        "strength_plate_start": _FI(py_type=str, data_type=_DT.STR),
        "number_anchorbolt_start": _FI(
...
class StbSecSteelFigureDampingDeviceHistory(StBridgeElement):
    ...
    Attributes:
        ...
        kind_section_stiffner (StbSecSteelFigureDampingDeviceHistoryKindSectionStiffner): 属性
        id_section_stiffner (int): 属性
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "strength": _FI(py_type=str, data_type=_DT.STR, required=True),
        "kind_section_stiffner": _FI(
            py_type=StbSecSteelFigureDampingDeviceHistoryKindSectionStiffner,
            data_type=_DT.STR_ENUM,
            choices=("RC", "S", "SRC", "CFT"),
        ),
        "id_section_stiffner": _FI(
            py_type=int, data_type=_DT.POSITIVE_INTEGER, xml_type="positiveInteger"
        ),
        "length": _FI(py_type=float, data_type=_DT.LENGTH, xml_type="length"),
    }
...
class StbSecConnectionIsolatingDeviceSp(StBridgeElement):
    ...
    Attributes:
        ...
        shape_plate_start (StbSecConnectionIsolatingDeviceSpShapePlateStart): 属性
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "shape_plate_start": _FI(
            py_type=StbSecConnectionIsolatingDeviceSpShapePlateStart,
            data_type=_DT.STR_ENUM,
            choices=("CIRCLE", "SQUARE"),
        ),
...
class StbSecBarArrangementSlabDeck(StBridgeElement):
    ...
    Attributes:
        depth_cover_top (float): 属性
        depth_cover_bottom (float): 属性
        d_refactory_bar (str): 属性
        strength_refactory_bar (str): 属性
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "d_refactory_bar": _FI(
            py_type=str, data_type=_DT.STR, xml_name="D_refactory_bar"
        ),
        "strength_refactory_bar": _FI(py_type=str, data_type=_DT.STR),
...
class StbSecBarBeamComplex(StBridgeElement):
    ...
    Attributes:
        stb_sec_bar_beam_complex_main (StbSecBarBeamComplexMain): 子要素 StbSecBarBeamComplexMain(コンクリート梁断面配筋・詳細・主筋)
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        "stb_sec_bar_beam_complex_main": _FI(
            ...
            max_occurs=1,
            min_occurs=1,
            py_type=StbSecBarBeamComplexMain,
        ),
...
class StbSecBarColumnCircleComplexMain(StBridgeElement):
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "distance": _FI(py_type=float, data_type=_DT.LENGTH, xml_type="length"),
...
class StbSections(StBridgeElement):
    ...
    Attributes:
        ...
        stb_sec_panel_zone (StbSecPanelZone): 子要素 StbSecPanelZone(柱梁接合部断面)
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_sec_panel_zone": _FI(
            kind=_FK.ELEMENT, max_occurs=1, py_type=StbSecPanelZone
        ),
...
class StbConnectionStiffner(StBridgeElement):
    """スチフナー配置情報：StbConnectionStiffner

    Attributes:
        id_stiffner (int): 属性 ID
...
class StbConnectionArrangement(StBridgeElement):
    ...
    Attributes:
        ...
        stb_connection_stiffner (list[StbConnectionStiffner]): 子要素 StbConnectionStiffner(スチフナー配置情報)
    """
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_connection_stiffner": _FI(
            kind=_FK.ELEMENT, py_type=list[StbConnectionStiffner]
        ),
    }
...
class StbPost(StBridgeElement):
    ...
    Attributes:
        ...
        steel_switch_heigth_top (float): 属性
...
class StbConnectionSpecStiffner(StBridgeElement):
    """スチフナープレート仕様：StbConnectionSpecStiffner
...
class StbConnectionSpecColumnH(StBridgeElement):
    ...
    Attributes:
        ...
        stiffner_size_up_connected (int): 属性 柱フランジ厚さに対する水平スチフナーのサイズアップ
        stiffner_size_up_connecting (int): 属性 梁フランジ厚さに対する水平スチフナーのサイズアップ
        ...
        stb_connection_spec_stiffner (list[StbConnectionSpecStiffner]): 子要素 StbConnectionSpecStiffner(スチフナープレート仕様)
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stiffner_size_up_connected": _FI(
            py_type=int, data_type=_DT.POSITIVE_INTEGER, xml_type="positiveInteger"
        ),
        "stiffner_size_up_connecting": _FI(
            py_type=int, data_type=_DT.POSITIVE_INTEGER, xml_type="positiveInteger"
        ),
        "rib_size_up": _FI(
            py_type=int, data_type=_DT.POSITIVE_INTEGER, xml_type="positiveInteger"
        ...
        "stb_connection_spec_stiffner": _FI(
            kind=_FK.ELEMENT, py_type=list[StbConnectionSpecStiffner]
        ),
...
class StbConnectionSpecBeamH(StBridgeElement):
    ...
    Attributes:
        ...
        rib_size_up (int): 属性 リブプレートのサイズアップ
        stb_connection_spec_gusset_plate (list[StbConnectionSpecGussetPlate]): 子要素 StbConnectionSpecGussetPlate(ガセットプレート仕様)
        stb_connection_spec_rib_plate (list[StbConnectionSpecRibPlate]): 子要素 StbConnectionSpecRibPlate(リブプレート仕様)
    """
    ...
    _fields: ClassVar[dict[str, _FI]] = {
        ...
        "stb_connection_spec_rib_plate": _FI(
            kind=_FK.ELEMENT, py_type=list[StbConnectionSpecRibPlate]
        ),
    }
